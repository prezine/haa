<?php
	...
	include_once './app/controllers/Haa.php';
						...
						<div class="col-12">
							<div class="page-title-box d-flex align-items-center justify-content-between">
								...
								<div class="page-title-right">
									<a href="./projects" class="btn btn-success">Add Projects</a>
								</div>
							</div>
						</div>
					</div>
										...
										<div class="card-body">
											<div class="media">
												<div class="media-body">
													...
													<h4 class="mb-0">
														<?php
															echo $product->counter('haa_projects');
														?>
													</h4>
												</div>
										...
										<div class="card-body">
											<div class="media">
												<div class="media-body">
													...
													<h4 class="mb-0">
														<?php
															echo $product->counter('haa_category');
														?>
													</h4>
												</div>
												<div class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon"> 
