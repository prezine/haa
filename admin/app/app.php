<?php
    ...
    */
    ...
    defined('APP_NAME')         OR define('APP_NAME', 'Haa');
    ...
    */
    ...
    defined('APP_URL')          OR define('APP_URL', 'http://127.0.0.1/haa/');
    ...
    */
    ...
    defined('DATABASE_NAME')    OR define('DATABASE_NAME', 'haa');
    ...
    defined('DATABASE_NAME')    OR define('DATABASE_NAME', 'haanig');

    defined('DATABASE_USER')    OR define('DATABASE_USER', 'haanig_admin');
